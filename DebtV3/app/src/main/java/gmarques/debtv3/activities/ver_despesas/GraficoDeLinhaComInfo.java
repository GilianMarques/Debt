...
public class GraficoDeLinhaComInfo {
    ...
    public GraficoDeLinhaComInfo(LineChart lineChart, Despesa despesa) {
    ...
    private void carregarDados() {
        ...
        ArrayList<Despesa> despesas = Despesas.getDespesas(despesa.getNome());

        for (Despesa despesa : despesas) {
            if (despesa.getMesId() == Despesa.RECORRENTE || despesa.getMesId() == Despesa.PARCELADA)
                continue;
            dados.add(new Entry(despesa.getDataDePagamento(), despesa.getValor()));
            Log.d(Tag.AppTag, "GraficoDeLinhaComInfo.carregarDados: "+despesa.toString());
        }
